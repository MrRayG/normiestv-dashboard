...
async function renderCinematicTrailer(
  ...
  for (let f = 0; f < TOTAL; f++) {
    ...
    if (t >= 9 && t < 15) {
      ...
      drawText(ctx, "— SKULLIEMOON", CANVAS_W / 2, CANVAS_H * 0.62 + 40, { size: 13, color: "#f97316", align: "center", alpha: qAlpha * alpha * 0.8, font: "Courier New" });
        ...
        <div className="bg-card border border-border rounded-lg p-5 space-y-4">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">20s dramatic reveal — Skulliemoon narration, Normie #306, burn data</p>
            </div>
          ...
          <div className="text-xs text-muted-foreground space-y-1 font-mono">
            ...
            <div className="flex items-center gap-2"><span className="text-primary">03</span> Burn data + Skulliemoon quote</div>
